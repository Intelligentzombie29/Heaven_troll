...
1. **Disappointment**: Jesus shows disapproval
2. **💩 Humiliation**: Player soils themselves in fear
3. **🔥 Divine Punishment**: Bursts into flames
4. **⚰️ Death**: Final demise while burning
...
1. **Download & Extract**: Place the `heaven-troll` folder in your FiveM server's `resources` directory
...
3. **Dependencies**: Ensure you have these resources installed:
   - `qb-core` (Required)
